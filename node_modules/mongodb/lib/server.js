...
// Allowed parameters
var legalOptionNames = ['poolSize', 'ssl', 'sslValidate', 'checkServerIdentity', 'sslCA'
  , 'sslCert', 'sslKey', 'sslPass', 'socketOptions', 'reconnectTries', 'reconnectInterval'
  , 'store', 'auto_reconnect', 'autoReconnect', 'emitError', 'bufferMaxEntries'
  , 'keepAlive', 'noDelay', 'connectTimeoutMS', 'socketTimeoutMS', 'loggerLevel', 'logger'
  , 'monitoring', 'haInterval'];
